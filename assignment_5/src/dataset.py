...
class CharCorruptionDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        trucated_doc = doc[:random_length]
        masked_content_length = random.randint(1, random_length//2)
        masked_content_start = random.randint(1, random_length - masked_content_length-1)
        prefix = trucated_doc[:masked_content_start]
        masked_content = trucated_doc[masked_content_start:masked_content_start+masked_content_length]
        suffix = trucated_doc[masked_content_start+masked_content_length:]
